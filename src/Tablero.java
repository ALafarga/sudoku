...
public class Tablero {
	 ...
	 * 
	 * <p>
	 * Si la casilla fue inicializada por el mismo juego no se puede borrar
	 * </p>
	 * 
	 * @param fila
	...
	/**
	 * Revisa si el numero/valor que se esta introduciendo en le juego es
	 ...
	 * 
	 * Recorrera el sector en el que se quiere comprobar la incosistencia a fin
	 * de saber si el valor existe en el sector
	 * 
	 * @param fila
	 * @param columna
	 * @param inicio
	 ...
	 * 
	 * Si no existe casilla en 0 o no utilizada y sin inconsistencia se gana el
	 * juego
	 * 
	 ...
	 * @param fila
	 * @param columna
	 * @return true si el valor es un valor inicializado por el juego y no por
	 *         el jugador
	 */
	...
	/**
	 * Cambia la matriz base TODO Falta un repaint PROBAR
	 * 
	 * @param matriz
	...
	public void setSudokuInterface(SudokuInterface sudokuInterface) {
